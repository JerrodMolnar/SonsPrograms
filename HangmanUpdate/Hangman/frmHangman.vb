...
Public Class frmHangman
    ...
    Private Sub txtInputLetter_TextChanged(sender As Object, e As EventArgs) Handles txtInputLetter.TextChanged
        ...
        If txtInputLetter.Text <> Space(1) Then
            ...
            If _strLetterGuessed <> "" Then
                ...
                If isValid(_strLetterGuessed) Then
    ...
    Private Function isValid(ByVal str As String) As Boolean
        Dim strPattern = "^[a-zA-Z]"
        Dim reg As New Regex(strPattern)
        Return reg.IsMatch(str)
    End Function

    Private Sub txtSpellWord_TextChanged(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles txtSpellWord.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then
            Dim strSpellWord = txtSpellWord.Text.ToUpper
            If strSpellWord = _strSecretWord Then
    ...
    Private Sub ResetGame()
        ...
        txtSpellWord.Clear()
        txtSpellWord.Visible = False
        lblSpellWord.Visible = False
        txtInputLetter.Visible = True
    ...
    Private Sub SpellWord()
        'Setup to spell word
        txtSpellWord.Visible = True
        txtSpellWord.Focus()
        lblSpellWord.Visible = True
        txtInputLetter.Visible = False
    End Sub
    ...
    Private Sub RandomNumber()
        ...
        If _strWords.Count <> 0 Then
            ...
            _strSecretWord = CType(_strWords(_intRandom), String)
            For intIndex As Integer = 0 To _strSecretWord.Length - 1
                lblSecretWord.Text += "-"
            Next
        Else
