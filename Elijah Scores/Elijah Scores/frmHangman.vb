...
Public Class frmHangman
    ...
    Private Sub PopulateWords()
        ...
        For intCount = 0 To datWords.Rows.Count - 1
            Dim strWordList As String = (datWords.Rows(intCount)(1).ToString)
    ...
    Private Sub RandomNumber()
        ...
        Else
            MsgBox("End of list" & vbNewLine & "You hung the man " & _intNumberOfHangs _
                   & " times.", , "No More Words")
            frmDailyActivity._blnSpellingDone = True
            Close()
        End If
    End Sub
    ...
    Private Sub frmHangman_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'SkipVocabWordsDataSet.SpellingWords' table. You can move, or remove it, as needed.
        Me.SpellingWordsTableAdapter.Fill(Me.SkipVocabWordsDataSet.SpellingWords)
